...
Per creare un eseguibile di nome "server", dove "server" e` il nome dell'eseguibile creato mentre "server_A.c" e` il nome del file sorgente:
$ gcc -o server server_5A.c
